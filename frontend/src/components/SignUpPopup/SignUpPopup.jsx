...
const SignUpPopup = ({ setShowSignUp }) => {
    ...
    const handleSubmit = (e) => {
        ...
        // Nếu không có lỗi, thông báo thành công và quay về trang chủ
    ...
    const isFormValid = Object.keys(errors).length === 0 && Object.values(formData).every(val => val);
            ...
            <div className="sign-up-popup-container">
                ...
                {step === 2 && (
                    <form onSubmit={handleSubmit}>
                        ...
                        >
                            {isFormValid ? 'Hoàn thành' : 'Vui lòng điền đầy đủ thông tin'}
                        </button>
                    </form>
                )}
            </div>
