...
//     // In ra menuItems mỗi khi nó thay đổi
//     useEffect(() => {
//         console.log("Updated menuItems:", menuItems); // In ra menuItems sau mỗi lần thay đổi
//     }, [menuItems]);
...
//                         {menuItems.length > 0 ? (
//                             menuItems.map((item) => (
//                                 <div key={item.item_id} className="menu-item" style={{ marginBottom: "20px", padding: "10px", border: "1px solid #ddd" }}>
//                                     <h3>{item.name}</h3>
//                                     <p>{item.description || "Chưa có mô tả."}</p>
//                                     <p><strong>Giá:</strong> {item.price} VND</p>
//                                     {item.img_url ? (
//                                         <img src={item.img_url} alt={item.name} style={{ maxWidth: "100%", height: "auto" }} />
//                                     ) : (
