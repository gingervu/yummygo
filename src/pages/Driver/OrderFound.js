...
import "./OrderFound.css";

const OrderFound = () => {
  const navigate = useNavigate(); // Khởi tạo hook navigate

  const handleButtonClick = () => {
    navigate("/orderdetails"); // Điều hướng đến trang /orderwaiting
  };

  return (
    <div className="order-found">
      {/* Header */}
      <Header />
